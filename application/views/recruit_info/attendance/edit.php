	...
	<div class="am-g">
		...
		<form class="am-form am-form-horizontal" action='<?=site_url("{$page_path}/edit_reco/{$info->id}"); ?>' method='post'>
				...
				<div class="am-u-sm-9">
					<select name="employee_id" id="">
						<?php foreach($gotdata as $key => $val): ?>
							<option value='<?=$val->id; ?>' <?php if ($val->id == $info->id) {echo 'selected';}; ?>><?=$val->name; ?></option>
						<?php endforeach; ?>
					</select>
					<small>员工你懂得...</small>
				</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='salary_level' placeholder="输入你的薪资水平 / Salary_level" value='<?=$info->salary_level; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='salary_pay' placeholder="输入你的支付薪资 / Salary_pay" value='<?=$info->salary_pay; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='other_pay' placeholder="输入你的支付薪资 / Other_pay" value='<?=$info->other_pay; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='real_pay' placeholder="输入你的支付薪资 / Real_pay" value='<?=$info->real_pay; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<textarea class="" rows="5" id="user-intro" name='remark' placeholder="输入备注"><?=$info->remark; ?></textarea>
					<small></small>
				</div>
			</div>
