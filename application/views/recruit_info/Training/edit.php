	...
	<div class="am-g">
		...
		<form class="am-form am-form-horizontal" action='<?=site_url("{$page_path}/edit_reco/{$info->id}"); ?>' method='post'>
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-name" name='name' placeholder="姓名 / Name" value='<?=$info->name; ?>'>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='lecturer' placeholder="输入你的电话号码 / Telephone" value='<?=$info->lecturer; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='budget' placeholder="输入你的电话号码 / Telephone" value='<?=$info->budget; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='attend_number' placeholder="输入你的电话号码 / Telephone" value='<?=$info->attend_number; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='attend_person' placeholder="输入你的电话号码 / Telephone" value='<?=$info->attend_person; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='attend_address' placeholder="输入你的电话号码 / Telephone" value='<?=$info->attend_address; ?>'>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<textarea class="" rows="5" id="user-intro" name='remark' placeholder="输入个人简介"><?=$info->remark; ?></textarea>
