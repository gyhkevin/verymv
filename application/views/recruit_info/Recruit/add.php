...
<![endif]-->
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加招聘信息</strong> / <small>Recruit information</small></div>
	</div>
	<hr/>
	<div class="am-g">
		...
		<form class="am-form am-form-horizontal" action='<?=site_url("{$page_path}/add_reco"); ?>' method='post'>
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-name" name='title' placeholder="职位 / Title">
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-name" name='title_sub' placeholder="职位副标题 / Title_sub">
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='limit_year' placeholder="输入你的工作年限 / Limit_year">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='limit_old' placeholder="输入你的年龄 / Limit_old">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='salary_level' placeholder="输入你的薪资水平 / Salary Level">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='number' placeholder="输入你的招聘人数 / Number">
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<textarea class="" rows="5" id="user-intro" name='title_desc' placeholder="输入职位描述"></textarea>
