      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
            ...
            <li><a href="<?=site_url($_SESSION['sidebar']['attendance_path']);?>"><span class="am-icon-calendar"></span> 考勤管理<span class="am-badge am-badge-secondary am-margin-right am-fr">24</span></a></li>
          </ul>
        </li>
