...
<![endif]-->
	...
	<div class="am-cf am-padding">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改部门</strong> / <small>add department</small></div>
	</div>
	<hr/>
	<div class="am-g">
		...
		<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
			<form class="am-form am-form-horizontal" action='<?=site_url("{$page_path}/add_reco/{$info->id}"); ?>' method='post'>
				<div class="am-form-group">
					<label for="user-name" class="am-u-sm-3 am-form-label">部门名称 / Name</label>
					<div class="am-u-sm-9">
						<input type="text" id="dept-name" name='department_name' placeholder="部门名称 / Name" value='<?=$info->name; ?>'>
