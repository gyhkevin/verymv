	...
	<div class="am-g">
		...
		<form class="am-form am-form-horizontal" action='<?=site_url("{$page_path}/edit_reco/{$info->id}"); ?>' method='post'>
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-name" name='user_name' placeholder="姓名 / Name" value='<?=$info->name; ?>'>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<select name="user_sex" id="">
						...
						<option value="0" <?php if($info->sex == 0) echo 'selected'; ?>>女</option>
					</select>
				</div>
			</div>
			...
			<div class="am-form-group">
				...
				<div class="am-u-sm-9">
					<input type="text" id="user-phone" name='user_phone' placeholder="输入你的电话号码 / Telephone" value='<?=$info->phone; ?>'>
				</div>
			</div>
