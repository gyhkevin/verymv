<div class="container-fluid">
	<div class="row-fluid">
		<div class="span12">
			...
			<div class="carousel slide" id="carousel-19192">
				<ol class="carousel-indicators">
					<li data-slide-to="0" data-target="#carousel-19192">
					</li>
					<li data-slide-to="1" data-target="#carousel-19192" class="active">
					</li>
					<li data-slide-to="2" data-target="#carousel-19192">
					</li>
				</ol>
				...
				</div> <a data-slide="prev" href="#carousel-19192" class="left carousel-control">‹</a> <a data-slide="next" href="#carousel-19192" class="right carousel-control">›</a>
			</div>
			<div class="hero-unit">
				<h1>
					Hello, world!
			...
			<div class="tabbable" id="tabs-221056">
				<ul class="nav nav-tabs">
					<li class="active">
						<a href="#panel-2553" data-toggle="tab">第一部分</a>
					</li>
					<li>
						<a href="#panel-261810" data-toggle="tab">第二部分</a>
					</li>
				</ul>
				<div class="tab-content">
					<div class="tab-pane active" id="panel-2553">
						<p>
							第一部分内容.
						</p>
					</div>
					<div class="tab-pane" id="panel-261810">
						<p>
							第二部分内容.
						</p>
					</div>
